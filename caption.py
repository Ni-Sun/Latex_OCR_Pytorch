...
import argparse
from model.dataloader import data_turn
...
def caption_image_beam_search(encoder, decoder, image_path, word_map, beam_size=5):
    ...
    with torch.no_grad():
        ...
        seqs_alpha = torch.ones(k, 1, enc_image_size[0], enc_image_size[1]).to(device)  # (k, 1, enc_image_size, enc_image_size)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img', '-i', default='./data/CROHME/images/images_train/TrainData2_15_sub_33.png',help='path to image')
